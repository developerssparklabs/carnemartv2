...
class Wcmlim
{
  ...
  private function define_admin_hooks()
  {
    ...
    $this->loader->add_action('restrict_manage_posts', $plugin_admin, 'wcmlim_display_location_filter_on_shoppge', 10);
    ...
    if (get_option('wcmlim_license') != '' || get_option('wcmlim_license') == 'valid') {
      ...
      if ($isTaxClassLineItem == 'on') {
        add_action(
          ...
          [$plugin_public, 'overwrite_tax_calculation_to_use_product_tax_class_and_location_zip_code'],
          10,
          3
        );
      }
