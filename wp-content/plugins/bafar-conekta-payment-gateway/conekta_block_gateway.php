...
class WC_Conekta_Gateway extends WC_Conekta_Plugin
{
    ...
    public function get_api_instance(): OrdersApi
    {
       ...
       // error_log("conekta  instance bafar.phgp" .  $location_apikey);
    ...
    public function process_payment($order_id)
    {
        ...
        try {
            ...
            // Obtener el valor actual del meta si existe
            $existingMeta = get_post_meta($order->get_id(), 'conekta-order-id', true);
           ...
           $orderStatus = $order->update_status('pending', __('Awaiting the conekta payment', 'woocommerce'));
            ...
            return array(
               ...
               'redirect' => '/pago-conekta?id=' . base64_encode($order_id)
            );
