...
function setGaugeMax(id, i, max, a, opts) {
    if (a === "set") {
        if (i > gauge.maxValue) {
            gauge.set(gauge.maxValue);
            document.getElementById('eib2bpro-Widget_' + id + '_Current').innerHTML = i;
        } else {
            gauge.set(i);
        }
    } else {

        var target = document.getElementById('eib2bpro-Widget_' + id + '_Canvas'); // your canvas element
        ...
        gauge.set(i);
        gauge.setTextField(document.getElementById('eib2bpro-Widget_' + id + '_Current'));

    }
}

(function () {
    var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q = [].slice,
        r = {}.hasOwnProperty,
        s = function (a, b) {
            function c() {
                this.constructor = a
    ...
    ! function () {
        ...
        var a, b, c;
        return b = 1 <= arguments.length ? q.call(arguments, 0) : [], c = b[0], a = b[1], k(c.toFixed(a))
    }, p = function (a, b) {
        var c, d;
        for (c in b) r.call(b, c) && (d = b[c], a[c] = d);
        return a
    }, n = function (a, b) {
        var c, d, e;
        d = {};
        for (c in a) r.call(a, c) && (e = a[c], d[c] = e);
        for (c in b) r.call(b, c) && (e = b[c], d[c] = e);
        return d
    }, k = function (a) {
        var b, c, d, e;
        ...
        return s(b, a), b.prototype.displayScale = 1, b.prototype.setTextField = function (a, b) {
        ...
        return s(b, a), b.prototype.displayedValue = 0, b.prototype.value = 0, b.prototype.setVal = function (a) {
        ...
        return s(b, a), b.prototype.displayedValue = 0, b.prototype.value = 0, b.prototype.options = {
            strokeWidth: .035,
            length: .1,
            color: "#000000"
        }, b.prototype.setOptions = function (a) {
            return null == a && (a = null), p(this.options, a), this.length = 2 * this.gauge.radius * this.options.length, this.strokeWidth = this.canvas.height * this.options.strokeWidth, this.maxValue = this.gauge.maxValue, this.minValue = this.gauge.minValue, this.animationSpeed = this.gauge.animationSpeed, this.options.angle = this.gauge.options.angle
        }, b.prototype.render = function () {
            var a, b, c, d, e, f, g;
        ...
        return s(b, a), b.prototype.elem = null, b.prototype.value = [20], b.prototype.maxValue = 80, b.prototype.minValue = 0, b.prototype.displayedAngle = 0, b.prototype.displayedValue = 0, b.prototype.lineWidth = 40, b.prototype.paddingTop = .1, b.prototype.paddingBottom = .1, b.prototype.percentColors = null, b.prototype.options = {
            colorStart: "#6fadcf",
            colorStop: void 0,
            gradientType: 0,
            strokeColor: "#e0e0e0",
            ...
            for (b = 0, f = !1, d = 0, e = a.length; e > d; d++) i = a[d], this.options.limitMax ? i = Math.min(Math.max(i, this.minValue), this.maxValue) : i > this.maxValue && (this.maxValue = 1.1 * this.value, f = !0), this.gp[b].value = i, this.gp[b++].setOptions({
        ...
        }, b.prototype.renderStaticLabels = function (a, b, c) {
            var d, e, f, g, h, i, j, k, l, n;
            for (this.ctx.save(), this.ctx.translate(b, c), d = a.font || "10px Times", i = /\d+\.?\d?/, h = d.match(i)[0], k = d.slice(h.length), e = parseFloat(h) * this.displayScale, this.ctx.font = e + k, this.ctx.textBaseline = "bottom", this.ctx.textAlign = "center", j = a.labels, f = 0, g = j.length; g > f; f++) n = j[f], l = this.getAngle(n) - 3 * Math.PI / 2, this.ctx.rotate(l), this.ctx.fillText(m(n, a.fractionDigits), 0, -this.radius - this.lineWidth / 2), this.ctx.rotate(-l);
            return this.ctx.restore()
        }, b.prototype.render = function () {
            var a, b, c, d, e, f, g, h, i, j, k, l;
            if (k = this.canvas.width / 2, d = this.canvas.height * this.paddingTop + this.availableHeight - (this.radius + this.lineWidth / 2) * this.extraPadding, a = this.getAngle(this.displayedValue), this.textField && this.textField.render(this), this.ctx.lineCap = "butt", this.options.staticLabels && this.renderStaticLabels(this.options.staticLabels, k, d), this.options.staticZones) {
                for (this.ctx.save(), this.ctx.translate(k, d), this.ctx.lineWidth = this.lineWidth, i = this.options.staticZones, e = 0, g = i.length; g > e; e++) l = i[e], this.ctx.strokeStyle = l.strokeStyle, this.ctx.beginPath(), this.ctx.arc(0, 0, this.radius, this.getAngle(l.min), this.getAngle(l.max), !1), this.ctx.stroke();
                this.ctx.restore()
            } else void 0 !== this.options.customFillStyle ? b = this.options.customFillStyle(this) : null !== this.percentColors ? b = this.getColorForValue(this.displayedValue, !0) : void 0 !== this.options.colorStop ? (b = 0 === this.options.gradientType ? this.ctx.createRadialGradient(k, d, 9, k, d, 70) : this.ctx.createLinearGradient(0, 0, k, 0), b.addColorStop(0, this.options.colorStart), b.addColorStop(1, this.options.colorStop)) : b = this.options.colorStart, this.ctx.strokeStyle = b, this.ctx.beginPath(), this.ctx.arc(k, d, this.radius, (1 + this.options.angle) * Math.PI, a, !1), this.ctx.lineWidth = this.lineWidth, this.ctx.stroke(), this.ctx.strokeStyle = this.options.strokeColor, this.ctx.beginPath(), this.ctx.arc(k, d, this.radius, a, (2 - this.options.angle) * Math.PI, !1), this.ctx.stroke();
            for (this.ctx.translate(k, d), j = this.gp, f = 0, h = j.length; h > f; f++) c = j[f], c.update(!0);
            return this.ctx.translate(-k, -d)
        }, b
    }(e), d = function (a) {
        function b(a) {
        ...
        return s(b, a), b.prototype.lineWidth = 15, b.prototype.displayedValue = 0, b.prototype.value = 33, b.prototype.maxValue = 80, b.prototype.minValue = 0, b.prototype.options = {
            lineWidth: .1,
            colorStart: "#6f6ea0",
            colorStop: "#c0c0db",
            strokeColor: "#eeeeee",
        ...
        return s(b, a), b.prototype.strokeGradient = function (a, b, c, d) {
            var e;
