   ...
   * Copyright (c)  Nattawat Nonsung; Licensed MIT */
  (function ($) {
      "use strict";
      ...
      var SlideReveal = function ($el, options) {
          ...
          if (self === top) {
              setting.overlayColor = 'rgba(0,0,0,0.6)';
          }
      ...
      $.extend(SlideReveal.prototype, {
          init: function () {
              ...
              if (setting.overlay) {
                  $el.css('z-index', setting.zIndex + parseInt($el.data('rel')));
                  self.overlayElement = $("<div class='slide-reveal-overlay'></div>")
                      .css({
                          ...
                          height: '100%',
                          width: '100%',
                          'z-index': setting.zIndex - 0 + parseInt($el.data('rel')),
          ...
          hide: function (triggerEvents) {
              ...
              if (triggerEvents === undefined || triggerEvents) {
                  if (setting.overlay) {
                      $overlayElement.removeClass('shown');
                  }
