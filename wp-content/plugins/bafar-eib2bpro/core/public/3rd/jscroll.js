            ...
            h = function () {
                ...
                if (t.length)
                    if (s.autoTrigger && (!1 === s.autoTriggerUntil || 0 < s.autoTriggerUntil)) {
                        ...
                        (a.height() < n ? a.height() : n) <= (0 < a.offset().top - r.scrollTop() ? r.height() - (a.offset().top - m(window).scrollTop()) : r.height()) && j(), f.off(".jscroll").on("scroll.jscroll", function () {
                            return j()
                        }), 0 < s.autoTriggerUntil && s.autoTriggerUntil--
                    } else f.off(".jscroll"), t.on("click.jscroll", function () {
                        return u(t), v(), !1
                    })
            },
            v = function () {
