...
<div class="eib2bpro-Container_Fluid">
    ...
    echo " eib2bpro-With_Text";
                    ...
                    <li class="more d-none">
                        <span class="eib2bpro-custom-icon fas fa-equals"></span>
                        <ul id="overflow">
                        </ul>
                    </li>
                </ul>
            ...
            <?php
            $eib2bpro_img_src = wp_get_attachment_image_src(eib2bpro_option('feature-logo'), 'full');
            ...
            <nav class="eib2bpro-MainMenu vertical eib2bpro-My fixed-bottom">
                <ul class="eib2bpro-menu">
                    <li class="text-center">
                        ...
                        <ul>
                            <?php if ("1" === eib2bpro_option('feature-own_themes') || is_admin(null) || (!is_admin(null) && '1' === eib2bpro_option('reactors-tweaks-settings-woocommerce', 0))) { ?>
                            <li>
                ...
                <div class="row">
                    <div class="col-8">
                        <div class="eib2bpro-search">
                            <input type="text" class="eib2bpro-search-box eib2bpro-search-input" data-close-on-empty="1" placeholder="<?php esc_html_e('Search orders, customers, products...', 'eib2bpro') ?>">
                        </div>
                    </div>
