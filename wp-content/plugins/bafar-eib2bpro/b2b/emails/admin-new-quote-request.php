...
class EIB2BPRO_New_Quote_Request extends \WC_Email
{
    ...
    {
        $this->id = 'eib2bpro_new_quote_request';
        $this->title = esc_html__('New quote request ', 'eib2bpro');
        $this->description = esc_html__('Email to be sent to admin when a new quote request', 'eib2bpro');

        $this->heading = esc_html__('New quote request', 'eib2bpro');
        $this->subject = esc_html__('New quote request', 'eib2bpro');

        // Template paths.
        $this->template_base = EIB2BPRO_DIR . 'b2b/emails/templates/';
        $this->template_plain = 'admin-new-quote-request.php';
        $this->template_html = 'admin-new-quote-request.php';
        ...
        add_action('eib2bpro_new_quote_request', array($this, 'trigger'), 10, 1);
...
return new \EIB2BPRO_New_Quote_Request();
