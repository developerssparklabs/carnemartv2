...
/**
 * This is our special Updater Plugin
 * We will use only one Actually
 * for our each Plugin
 * 
 * @author Saiful Islam <codersaiful@gmail.com>
 * @package CodeAstrology_Plugin_Updater
 */
if ( ! class_exists( 'CodeAstrology_Plugin_Updater' ) ) {
	 ...
	 * @version 1.0.0.1
	 */
	class CodeAstrology_Plugin_Updater {
		...
		/**
		 * Cache will delete after this time.
		 * Obviously we have to store this property 
		 * this way: such: +1 minute +1 second  +3 hours
		 * 
		 * Because, over there, I have used strtotime() function.
		 * and this property will use as first parameter of strtotime() function-
		 * where obviously need string time formate
		 * 
		 * @author Saiful Islam <codersaiful@gmail.com>
		 *
		 * @var string Example: +1 minute +1 second  +3 hours
		 */
		private $cache_expire_time = '+3 hours';
		 ...
		 * @uses hook()
		 *
		 * @param string  $_api_url     https://codeastrology.com - The URL pointing to the custom API endpoint.
		 * @param string  $_plugin_file Plugin Root Path to the plugin root file file. such: in root the value of __FILE__;
		 ...
		 *
		 * @see CodeAstrology_Plugin_Updater::request_recently_failed
		 *
		 * @since 1.9.1
		 */
		...
		public function set_version_info_cache( $value = '', $cache_key = '' ) {
			...
			$data = array(
				'timeout' => strtotime( $this->cache_expire_time, time() ),
