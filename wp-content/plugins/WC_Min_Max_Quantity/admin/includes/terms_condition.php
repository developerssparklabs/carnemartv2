<div class="wcmmq-each-terms-wrapper">
    ...
    <table class="wcmmq_config_form">
        <tr>
            <th><label><?php echo esc_html__( 'Choose a', 'wcmmq_pro' ); ?> <?php echo esc_html( $term_name ); ?></label></th>
            <td class="">
    ...
    <div class="wcmmq_terms_wrapper term_wrapper_<?php echo esc_attr( $term_key ); ?>">
        ...
        <ul class="wcmmq_each_terms_header" data-target="term_table_<?php echo esc_attr( $id ); ?>">
            ...
            <li class="delete"><?php echo esc_html__( 'Delete', 'wcmmq_pro' ); ?></li>
         </ul> 
            <table id="term_table_<?php echo esc_attr( $id ); ?>">
        <tr>
            <th>
                <label><?php echo esc_html__( 'Minimum Quantity', 'wcmmq_pro' ); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label><?php echo esc_html__( 'Maximum Quantity', 'wcmmq_pro' ); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label><?php echo esc_html__( 'Step Quantity', 'wcmmq_pro' ); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label><?php echo esc_html__( 'Default Quantity', 'wcmmq_pro' ); ?></label>
            </th>
            <td>
